# Placement debug baseline: no fellow (negative control for parser signals).
# Fellow metrics should remain absent; no placement command should be observed.
# Use with fellow_placement_debug_runner for sanity checks.
