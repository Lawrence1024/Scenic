...
# Fellow on RIGHT TTL at reduced speed (~32 mph) so ego on optimal has a clearer left-side bypass than 60 mph traffic.
...
opponent.behavior = FellowFollowTTLGeometricBehavior(speed_mph=32)
