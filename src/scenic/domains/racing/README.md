...
- **Planner roadmap (Phases 0–2)**: baseline telemetry + Phase 0 benchmark bank (`phase0_runner`), scripted planner-to-MPC TTL handoff + Phase 1 validation (`phase1_runner`), and Phase 2 opponent situation features (`situation_assessment`, `[Phase2]` logs, pytest snapshots). Status: `plans/README.md`.
