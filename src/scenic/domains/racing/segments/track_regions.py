...
- mainTrack: main road segments with 5m on each side of the centerline (default).
- pitTrack: pit lane segments with 2m on each side of the centerline (default).
...
MAIN_TRACK_BUFFER_M = 5.0
PIT_TRACK_BUFFER_M = 2.0
...
def build_track_regions_from_opendrive(
    ...
    Args:
        ...
        main_buffer_m: Buffer in meters on each side of main segment centerlines (default 5).
        pit_buffer_m: Buffer in meters on each side of pit segment centerlines (default 2).
...
def build_track_regions_from_ttl(
    ...
    Args:
        ...
        main_buffer_m: Buffer in meters on each side of main centerline (default 5).
        pit_buffer_m: Buffer in meters on each side of pit centerline (default 2).
...
def create_track_regions(
    ...
    **create_track_kw,
    ...
    Args:
        ...
        main_buffer_m: Buffer each side of main centerline in meters (default 5).
        pit_buffer_m: Buffer each side of pit centerline in meters (default 2).
